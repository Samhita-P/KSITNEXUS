...
class Notice(models.Model):
    ...
    # Targeting
    target_branches = models.JSONField(default=list, blank=True)  # List of branch names
    target_years = models.JSONField(default=list, blank=True)  # List of years
...
class Announcement(models.Model):
    ...
    target_details = models.JSONField(default=dict, blank=True)  # Additional targeting info
